                    ...
                    <div className="print-joke-container">
                        ...
                        <div key={joke.key} index={index} id={joke.key} className="joke-card">
                            ...
                            <button
                                ...
                                onClick={() => props.incrementScore(joke.key, joke.likeCount, joke.userValue)}><i class="far fa-thumbs-up"></i>{joke.likeCount}
                            </button>
                            ...
                            <button className="counter-action decrement button"
                                ...
                                <i class="far fa-thumbs-down"></i> {joke.dislikeCount}
                            </button>
